...
data_1 <- read.delim("data/9_1000_0.tsv", header = T,row.names = 1)
head(data_1)
...
mynoiseq.deg
write.csv(mynoiseq.deg,"Data/r_results/results_9_1000_0.7.csv", row.names = TRUE)


mynoiseq.deg1 = degenes(mynoiseq.tmm, q = 0.7, M = "up")
write.csv(mynoiseq.deg1,"Data/r_results/results_9_1000_0.7_up.csv", row.names = TRUE)


mynoiseq.deg2 = degenes(mynoiseq.tmm, q = 0.7, M = "down")
write.csv(mynoiseq.deg2,"Data/r_results/results_9_1000_0.7_down.csv", row.names = TRUE)
