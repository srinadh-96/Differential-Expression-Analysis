...
write.csv(DE.up,"/Users/kariprivat/Documents/results_3_750_250_up.csv", row.names = TRUE)
write.csv(DE.dowm,"/Users/kariprivat/Documents/results_3_750_250_down.csv", row.names = TRUE)
write.csv(DE,"/Users/kariprivat/Documents/results_3_750_250.csv", row.names = TRUE)
