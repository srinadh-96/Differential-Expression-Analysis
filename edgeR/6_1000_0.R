...
write.csv(DE.up,"/Users/kariprivat/Documents/results_6_1000_0_up.csv", row.names = TRUE)
write.csv(DE.dowm,"/Users/kariprivat/Documents/results_6_1000_0_down.csv", row.names = TRUE)
write.csv(DE,"/Users/kariprivat/Documents/results_6_1000_0.csv", row.names = TRUE)
