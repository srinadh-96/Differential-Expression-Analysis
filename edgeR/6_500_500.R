...
write.csv(DE.up,"/Users/kariprivat/Documents/results_6_500_500_up.csv", row.names = TRUE)
write.csv(DE.dowm,"/Users/kariprivat/Documents/results_6_500_500_down.csv", row.names = TRUE)
