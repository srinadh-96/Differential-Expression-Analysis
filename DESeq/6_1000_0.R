...
data <- read.delim("data/6_1000_0.tsv", header=T, row.names=1)
...
write.csv(down, "data/pvalue5/results_down_6_1000_0.csv", row.names=TRUE)

write.csv(up, "data/pvalue5/results_up_6_1000_0.csv", row.names=TRUE)

write.csv(resSig, "data/pvalue5/results_6_1000_0.csv", row.names=TRUE)
...
write.csv(down2, "data/pvalue10/results_down_6_1000_0.csv", row.names=TRUE)

write.csv(up2, "data/pvalue10/results_up_6_1000_0.csv", row.names=TRUE)

write.csv(resSig2, "data/pvalue10/results_6_1000_0.csv", row.names=TRUE)
...
write.csv(down3, "data/pvalue20/results_down_6_1000_0.csv", row.names=TRUE)

write.csv(up3, "data/pvalue20/results_up_6_1000_0.csv", row.names=TRUE)

write.csv(resSig3, "data/pvalue20/results_6_1000_0.csv", row.names=TRUE)
